  ...
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        ...
        <a class="nav-link text-decoration-none text-reset" href="<?=base_url('home/tambah')?>">Tambah</a>
        <a class="nav-link text-decoration-none text-reset" href="<?=base_url('home/list')?>">List</a>
				<a href="<?=base_url('home/index')?>" class="btn btn-lg btn-secondary fw-bold border-white bg-white text-dark">Logout</a>
      </nav>
    </div>
  </header>
